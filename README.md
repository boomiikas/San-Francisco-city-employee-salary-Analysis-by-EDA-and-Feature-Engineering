...
Benefits : 36163 rows has nan out of 148654 =24% --> so I used median to fill the nan values and BasePay : 605 has null values, = 0.4% -->here , i dropped rows , doesnt make significant changes
